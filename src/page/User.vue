	...
	<transition name="slide">
		<div class="user">
			...
			<div class="container-item" v-show="selected==='mylikeSongs'">
				...
				<ul class="list">
					<li v-for="(item,index) in mylikeSongs" class="item" @click="selectItem(mylikeSongs,index,'mylikeSongs')" :key="index">
			...
			<div class="container-item" v-show="selected==='playHistory'">
				...
				<ul class="list">
					<li v-for="(item,index) in playHistory" class="item" @click="selectItem(playHistory,index,'playHistory')" :key="index">
